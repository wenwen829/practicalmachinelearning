...
```
The accurancy of fit model for predicting out of sample data is around 99% again, I consider this a desirable result and will use the model to answer my assignment question.
```{r testp1}
